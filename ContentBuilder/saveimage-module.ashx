...
Public Class saveimage : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        imgOri = System.Drawing.Image.FromStream(filecover.InputStream)

        Dim nWidth As Integer = imgOri.Size.Width
        Dim nHeight As Integer = imgOri.Size.Height
        ...
        If nWidth <= 1600 Then
            ...
            context.Response.Write("<html><body onload=""parent.sliderImageSaved('" & pagefolderpath & rndStr & fileext & "')""></body></html>")
        Else
